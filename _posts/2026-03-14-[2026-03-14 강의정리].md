...
subtitle: LangChain LCEL 심화 (RunnableParallel, RunnableBranch) + Gradio UI + FAQ 챗봇 구현
description: LangChain LCEL 심화 (RunnableParallel, RunnableBranch) + Gradio UI + FAQ 챗봇 구현
